...
1. Identify the input format:
   ...
   - If the input is neither valid JSON nor valid CSV, stop and return a clear error: "The input does not appear to be valid JSON or CSV. Please check the format and try again. If you need help, describe what you're trying to do."
